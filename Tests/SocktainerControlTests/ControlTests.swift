...
@testable import SocktainerControl

@Suite("Socktainer control contract")
struct ControlTests {
    ...
    func parsesChunkedResponse() throws {
        ...
        #expect(String(decoding: result.body, as: UTF8.self) == "Socktainer")
    }
    ...
    func launchAgentPropertyList() throws {
        ...
        let data = try DaemonLifecycle.launchAgentPropertyList(
            daemonExecutable: URL(fileURLWithPath: "/opt/socktainer/bin/socktainer"),
            paths: paths
        )
        ...
        #expect(value["ProgramArguments"] as? [String] == ["/opt/socktainer/bin/socktainer"])
        #expect(value["StandardOutPath"] as? String == "/Users/test/Library/Logs/Socktainer/daemon.log")
        #expect(value["StandardErrorPath"] as? String == "/Users/test/Library/Logs/Socktainer/daemon-error.log")
    }
    ...
    func snapshotRoundTrip() throws {
        let snapshot = ControlSnapshot(
            ...
            diagnostics: ControlDiagnostics(
                ...
                installation: InstallationInfo(kind: .package, executablePath: "/opt/socktainer/bin/socktainer"),
                paths: ControlPaths(
    ...
    func startIsIdempotent() throws {
        ...
        #expect(decision == .noChange("Socktainer is already running."))
    }
    ...
    func resolvesSiblingDaemon() throws {
        ...
        let daemon = directory.appendingPathComponent("socktainer")
        ...
        let lifecycle = DaemonLifecycle(
            ...
            currentExecutable: directory.appendingPathComponent("socktainerctl")
        )
