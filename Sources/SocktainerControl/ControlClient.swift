            ...
            do {
                ...
                return ControlSnapshot(
                    daemon: DaemonStatus(
                        ...
                        version: version.Components.first(where: { $0.Name == "socktainer" })?.Version,
        ...
        try await Task.detached(priority: .userInitiated) {
            try ControlOperationLock.withLock(
                ...
                case .startDaemon:
                    ...
                    return ActionResult(succeeded: true, message: "Socktainer is starting.")
                case .stopDaemon:
                    ...
                    return ActionResult(succeeded: true, message: "Socktainer stopped.")
                case .restartDaemon:
                    let context = try Self.daemonSafetyContext(lifecycle: self.lifecycle)
                    ...
                    return ActionResult(succeeded: true, message: "Socktainer is restarting.")
