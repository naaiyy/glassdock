...
export default function Socktainer() {
  ...
  return (
    <List
      isLoading={isLoading}
      searchBarPlaceholder="Search Socktainer and containers"
    >
      {error ? (
        <List.EmptyView
          icon={Icon.ExclamationMark}
          title="Cannot load Socktainer"
...
function StatusDetail({
  ...
  return (
    <Detail
      navigationTitle="Socktainer Status"
      markdown={`# Socktainer ${snapshot.daemon.state}\n\n${snapshot.daemon.message ?? "The local Docker-compatible endpoint is available."}`}
      metadata={
        <Detail.Metadata>
      ...
      actions={
        <ActionPanel>
          ...
          {snapshot.daemon.state === "stopped" ? (
            <Action
              title="Start Socktainer"
              icon={Icon.Play}
              onAction={() => perform(["daemon", "start"], "Socktainer")}
            />
          ) : snapshot.daemon.managed ? (
            <>
              <Action
                title="Restart Socktainer"
                icon={Icon.Repeat}
                onAction={() => perform(["daemon", "restart"], "Socktainer")}
              />
              <Action
                title="Stop Socktainer"
                icon={Icon.Stop}
                style={Action.Style.Destructive}
                onAction={() => perform(["daemon", "stop"], "Socktainer")}
              />
            </>
          ) : null}
          <Action.Push
...
function DiagnosticsDetail() {
  ...
  return (
    <Detail
      isLoading={isLoading}
      navigationTitle="Socktainer Diagnostics"
